...
from model_resnext101 import EncoderCNN
from Transformer_CTT_STT_Memory40 import MemoryTransformer
...
parser.add_argument('--data_name', type=str, default='resnext101_32x8d')
